 ...
 * @author ANDY
 */
public class DLG_Mantenimiento_Sede extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true), "Mantenimiento de Sedes:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DLG_Mantenimiento_Sede.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DLG_Mantenimiento_Sede dialog = new DLG_Mantenimiento_Sede(new javax.swing.JFrame(), true);
    ...
    private void Guardar() {
        ...
        {
            ctrl.GrabarData("sede","descripcion","'"+TXdescripcion.getText().trim()+"'");
            Cancelar();
        }
    }
    ...
    private void Cancelar() {
        ...
        ctrl.VisualizarEnTabla("sede", TBalmacen,"");
    ...
    private void Editar() {
        ...
        {
            ctrl.ActualizarData("sede", "descripcion='"+TXdescripcion.getText().trim(),"idsede='"+ctrl.ValorTabla(TBalmacen, 0)+"'");
            Cancelar();
        }
    }
