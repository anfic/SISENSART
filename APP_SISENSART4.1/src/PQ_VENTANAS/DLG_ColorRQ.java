 ...
 * @author ANDY CLARK
 */
public class DLG_ColorRQ extends javax.swing.JDialog {
    CLS_Controlador ctrl=new CLS_Controlador();
    /**
     * Creates new form DLG_ColorRQ
     */
    public DLG_ColorRQ(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Mantenimiento de Colores RQ");
        setResizable(false);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true), "ColorRQ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DLG_ColorRQ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DLG_ColorRQ dialog = new DLG_ColorRQ(new javax.swing.JFrame(), true);
    ...
    private void Grabar() {
        if (TXcargo.getText().trim().length() == 0) {
            ...
            ctrl.GrabarData("color", "descripcion", "'" + TXcargo.getText().trim().toUpperCase() + "'");
            Cancelar();
        }
    }
    private void Cancelar() {
        ctrl.VisualizarEnTabla("color", TBcargo, "");
        TXcargo.setText("");
    ...
    private void Modificar() {
        if (TXcargo.getText().trim().length() == 0) {
            ...
            ctrl.ActualizarData("color", "descripcion='" + TXcargo.getText().trim() + "'", "idcolor='" + TBcargo.getValueAt(TBcargo.getSelectedRow(), 0).toString().trim() + "'");
            Cancelar();
        }
    }
