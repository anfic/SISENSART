...
public class DLG_CARGOS extends javax.swing.JDialog {
    ...
    private void Grabar()
    {
        ...
        {
            ctrl.GrabarData("cargo", "descripcion,tipo",  "'"+TXcargo.getText().trim().toUpperCase()+"','"+CBtipo.getSelectedItem().toString().trim()+"'");
            Cancelar();
        }
    }
    private void Modificar()
    {
        ...
        {
            ctrl.ActualizarData("cargo","descripcion='"+TXcargo.getText().trim()+"',tipo='"+CBtipo.getSelectedItem().toString().trim()+"'", "id_cargo='"+TBcargo.getValueAt(TBcargo.getSelectedRow(), 0).toString().trim()+"'");
            Cancelar();            
        }
    }
    ...
    private void initComponents() {
        ...
        CBtipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "A", "B" }));
    ...
    private void TXbuscarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TXbuscarKeyTyped
        // TODO add your handling code here:
        ctrl.BuscarJtable(TXbuscar, TBcargo,1);
