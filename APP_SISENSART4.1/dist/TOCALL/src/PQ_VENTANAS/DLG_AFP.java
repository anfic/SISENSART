 ...
 * @author anfic
 */
public class DLG_AFP extends javax.swing.JDialog {

    CLS_Controlador ctrl=new CLS_Controlador();
    /**
     * Creates new form DLG_AFP
     */
    public DLG_AFP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Cancelar();
    }
    ...
    private void initComponents() {
        ...
        TBafp = new javax.swing.JTable();
        jLabel2 = new javax.swing.JLabel();
        TXbuscar = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Mantenimiento de AFP's");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true), "Mantenimiento de AFP´s", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 13))); // NOI18N
        ...
        TBafp.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        TBafp.getTableHeader().setReorderingAllowed(false);
        TBafp.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TBafpMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(TBafp);
        if (TBafp.getColumnModel().getColumnCount() > 0) {
            TBafp.getColumnModel().getColumn(0).setResizable(false);
            TBafp.getColumnModel().getColumn(1).setResizable(false);
            TBafp.getColumnModel().getColumn(1).setPreferredWidth(250);
        }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(TXdescripcion, javax.swing.GroupLayout.PREFERRED_SIZE, 381, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(TXbuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void TBafpMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TBafpMouseClicked
        // TODO add your handling code here:
        PasarDatos();
    }//GEN-LAST:event_TBafpMouseClicked

    private void TXdescripcionKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TXdescripcionKeyPressed
        // TODO add your handling code here:
        ctrl.PulsarEnter(evt, BTn);
    ...
    private void TXbuscarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TXbuscarKeyTyped
        // TODO add your handling code here:
        ctrl.BuscarJtable(TXbuscar, TBafp,1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DLG_AFP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DLG_AFP dialog = new DLG_AFP(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable TBafp;
    ...
    private void Cancelar() {
        ...
        TXbuscar.setText("");
        ctrl.VisualizarEnTabla("afp", TBafp, "");
    ...
    private void Grabar() {
        ...
        {
            ctrl.mensaje.MensajeAlerta("Ud. no registró ninguna descripción");
            Cancelar();
        }
        else
        {
            ctrl.GrabarData("afp", "descripcion", "'"+TXdescripcion.getText().trim()+"'");
            Cancelar();
        }
    }
    ...
    private void Modificar() {
        ...
        {
            ctrl.ActualizarData("afp", "descripcion='"+TXdescripcion.getText().trim()+"'","id_afp='"+TBafp.getValueAt (TBafp.getSelectedRow(),0).toString().trim()+"'");
            Cancelar();
        }
    }
    ...
    {
        TXdescripcion.setText(TBafp.getValueAt(TBafp.getSelectedRow(), 1).toString().trim());
