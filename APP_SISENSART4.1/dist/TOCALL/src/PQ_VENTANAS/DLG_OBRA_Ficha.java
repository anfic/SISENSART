 ...
 */
public class DLG_OBRA_Ficha extends javax.swing.JDialog {
     ...
     */
    public DLG_OBRA_Ficha(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        ctrl.VisualizarEnTabla("OBRA_PLANTA", TBobra, "where descripcion like '%"+jTextField1.getText().trim()+"%'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            IFRM_Ficha_Datos.TXobra.setText(ctrl.ValorTabla(TBobra, 0));
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DLG_OBRA_Ficha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DLG_OBRA_Ficha dialog = new DLG_OBRA_Ficha(new javax.swing.JFrame(), true);
