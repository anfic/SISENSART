 ...
 * @author anfic
 */
public class DLG_Consulta_FotoCheck_Obra extends javax.swing.JDialog {

    CLS_Controlador ctrl = new CLS_Controlador();
    Reportes rpt = new Reportes();

    /**
     * Creates new form DLG_Consulta_FotoCheck_Obra
     */
    public DLG_Consulta_FotoCheck_Obra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Reporte de Inducciones.");
        setResizable(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (TBpersonal.getSelectedRow() == -1) {
            ...
            if (ctrl.mensaje.MsjeConfirmacion("Está seguro que desea seleccionar este personal?") == 0) {
                this.dispose();
                rpt.Reporte_1Parametro_Imagen("RPT_Inducciones.jasper", "p_dni", ctrl.ValorTabla(TBpersonal, 0), "p_logo", "/PQ_IMAGENES/LogoSantisimaCruzEdit.png");
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DLG_Consulta_FotoCheck_Obra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DLG_Consulta_FotoCheck_Obra dialog = new DLG_Consulta_FotoCheck_Obra(new javax.swing.JFrame(), true);
