 ...
 */
public class DLG_Personal_Induccion extends javax.swing.JDialog {

    CLS_Controlador ctrl=new CLS_Controlador();
    /**
     * Creates new form DLG_Personal_Ficha
     */
    public DLG_Personal_Induccion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
            ...
            {
                DLG_Induccion_Personal.TXdni.setText(ctrl.ValorTabla(TBpersonal, 0));
                dispose();
            }
            else
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DLG_Personal_Induccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DLG_Personal_Induccion dialog = new DLG_Personal_Induccion(new javax.swing.JFrame(), true);
