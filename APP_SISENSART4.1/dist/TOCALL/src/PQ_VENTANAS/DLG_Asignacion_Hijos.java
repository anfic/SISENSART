 ...
 */
public class DLG_Asignacion_Hijos extends javax.swing.JDialog {

    CLS_Controlador ctrl=new CLS_Controlador();
    /**
     * Creates new form DLG_Asignacion_Hijos
     */
    public DLG_Asignacion_Hijos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void Cancelar()
    {
        TXhijo.setText("");
        TXfecha.setText("");
        ctrl.VisualizarEnTabla("hijos", TBhijo, "where dni='"+TXdni.getText().trim()+"'");
    }
    ...
    {
        if (LBpadre.getText().trim().length()*TXdni.getText().trim().length()==0)
        {
            ctrl.mensaje.MensajeAlerta("Ud. no seleccionó los datos del personal");
            ctrl.Maracar(TXdni);
        }
        else if(TXhijo.getText().trim().length()==0)
        {
            ctrl.mensaje.MensajeAlerta("Ud. no registró el nombre del hijo");
            ctrl.Maracar(TXhijo);
        }
        else if(TXfecha.getText().trim().length()>10)
        {
            ctrl.mensaje.MensajeAlerta("Ud. no registró la fecha de nacimiento.");
            TXfecha.requestFocus();
        }
        else
        {
            ctrl.GrabarData("hijos", "nombre_apellido,fecha_nac,dni", "'"+TXhijo.getText().trim()+"','"+TXfecha.getText().trim()+"','"+TXdni.getText().trim()+"'");
            Cancelar();
        }
    }
    ...
    private void initComponents() {
        ...
        TXhijo = new javax.swing.JTextField();
        ...
        setTitle("Ventana de asignación de hijos.");
        ...
        jLabel2.setText("Nombre de Hijo:");

        TXhijo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TXhijoKeyPressed(evt);
            }
        });
        ...
        if (TBhijo.getColumnModel().getColumnCount() > 0) {
            TBhijo.getColumnModel().getColumn(1).setPreferredWidth(250);
        }
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(TXhijo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void BTelimnarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTelimnarActionPerformed
        ...
        else
        {
            ...
            {
                ctrl.EliminarData("hijos", "where id_hijo='"+ctrl.ValorTabla(TBhijo, 0)+"'");
                Cancelar();
            }
            else
            {
    ...
    private void TXhijoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TXhijoKeyPressed
        // TODO add your handling code here:
        ctrl.PulsarEnter(evt, TXfecha);
    }//GEN-LAST:event_TXhijoKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DLG_Asignacion_Hijos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DLG_Asignacion_Hijos dialog = new DLG_Asignacion_Hijos(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField TXhijo;
